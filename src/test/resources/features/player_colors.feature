# language: de
Funktionalität: Die Logik muss für die gewählte Spieleranzahl die Farben auswählen. Die Reihenfolge der Wahl ist Rot, Grün, Blau und dann Weiß.
  Die Funktionalität implementiert dabei die Funktion 'Color[] players()' des Interfaces 'Game'.

  Szenario: Peter schaut sich die Farben im Spiel mit 2 Spielern an.
